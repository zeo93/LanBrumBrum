...
/**
 * Controllo giornaliero in background (anche ad app chiusa):
 * scadenze di manutenzioni/bollo/revisione/assicurazione e nuove versioni su GitHub.
 */
public class DailyWorker extends Worker {
    ...
    public Result doWork() {
        ...
        if (Prefs.notificheAttive(c)) {
            NotificationHelper.checkScadenze(c);
        }
    ...
    public static void schedule(Context c) {
        ...
        WorkManager.getInstance(c).enqueueUniquePeriodicWork(
                "controllo_giornaliero", ExistingPeriodicWorkPolicy.KEEP, req);
    }
}
